...
At the moment, Reentry Server only supports the most basic scenario for interacting with the Atmosphere Community Server test client. To wit, a user can enter a world. That’s it. Chat messages aren’t even implemented yet.
