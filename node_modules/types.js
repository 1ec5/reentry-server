...
//TypeTuple.prototype.unpack = function (data, offset) {
//	offset = offset || 0;
//	for (var i = 0; i < this.length; i++) {
//		var length = this.prototypeItem.type.length;
//		var count = 1;
//		if (this.prototypeItem.type instanceof VarType) {
//			var lengthItem = byteItem();
//			count = lengthItem.unpack(data, offset);
//			offset += lengthItem.type.length;
//			if (count < 0) continue;	// NULL
//		}
//		this.items[i] = this.prototypeItem.unpack(data, offset, count);
//		offset += length * count;
//	}
//	return this.items;
//};
//TypeTuple.prototype.pack = function () {
//	var prototypeType = this.prototypeItem.type;
//	for (var i = 0; i < this.length; i++) {
//		var value = (this.items[i] !== undefined ? this.items[i] :
//					 prototypeType.defaultValue);
//		if (prototypeType instanceof VarType) values.push(value.length);
//		values.push(value);
//	}
//	var fmt = ("<" + this.format);
...
TypeStruct.prototype.pack = function () {
	...
	for (var i = 0; i < this.constructor.items.length; i++) {
		...
		if (item instanceof ArrayItem) values = values.concat(value);
	...
	get: function () {
		...
		for (var i = 0; i < this.constructor.items.length; i++) {
			...
			if (item instanceof ArrayItem) {
				console.log(">>> Adding " + item.type.format.repeat(this[item.name].length) + " to " + format);	// debug
...
//	arrayItem(TypeString, "prop_names"),
//	arrayItem(TypeInt, "prop_perms"),
//	arrayItem(TypeString, "prop_values"),
//	intItem("cookie"),
//];
