...
TypeTuple.prototype.pack = function () {
	...
	for (var i = 0; i < this.length; i++) {
		var value = (this.items[i] !== undefined ? this.items[i] :
					 prototypeItem.type.defaultValue);
		if (prototypeItem.type instanceof VarType) values.push(value.length);
		if (prototypeItem instanceof ArrayItem) values = values.concat(value);
		values.push(value);
	}
	var fmt = "<" + this.format;
